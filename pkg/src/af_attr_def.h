...
#define _ATTRIBUTES \
    ...
    _ATTRDEF(51619, DEBUG_LEVEL,        0,  5, OTAMGR,     AF_ATTR_FLAG_WRITABLE), \
    ...
    _ATTRDEF(65012, COMMAND,            0,  5, HUBBY,      AF_ATTR_FLAG_WRITABLE ), \
    _ATTRDEF(65013, ASR_STATE,          0,  5, HUBBY,      AF_ATTR_FLAG_WRITABLE ), \
    _ATTRDEF(65015, LINKED_TIMESTAMP,   0,  5, HUBBY,      AF_ATTR_FLAG_WRITABLE ), \
    _ATTRDEF(65016, AD_SECRET_DURATION, 0,  5, HUBBY,      AF_ATTR_FLAG_WRITABLE | AF_ATTR_FLAG_NOTIFY), \
    _ATTRDEF(65017, AD_SECRET,          0,  5, HUBBY,      AF_ATTR_FLAG_NOTIFY), \
